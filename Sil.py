...
cl = LineAlpha.LINE()
cl.login(token="EopmKmPhK5ZQ38FpAhx5.nqZhqiZgZilGvU4eyth5jq.zG372nK7vSn2MkSPWJnX6a9ib2gj0d8zIilJ/JnLTa0=")
cl.loginResult()
...
║кσ@ι∂ (тєχт)
╰════╬♥╬════╯
http://line.me/ti/p/~jkp4678"""
KAC=[cl]
mid = cl.getProfile().mid
Bots=["u350cc7408cc6cc82e056ee046131f925"]
admin=["u350cc7408cc6cc82e056ee046131f925","u0548e577b8d144d19d36617941d15062","uc2e8b426f6591045943eae5304e67c32","ub23ad49c409ac6773c4a151114e4761c","ub51bc97c5e4f603f1dff35e9512550d3","uf44a92c0c62be1ff5a7e7a73758aad4f"]
wait = {
    'contact':False,
    'autoJoin':True,
			...
			cl.sendMessage(to, "Sukses join ke grup %s" % str(group.name))
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧\nα¢тινє яєα∂єяѕ:%s\n\n\n\nραѕѕινє яєα∂єяѕ:\n%s\n\n❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧\nιи тнє ℓαѕт ѕєєи ρσιит:\n[%s]\n❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧❧\n TBA" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#----------------Commandtambahan----------------------#
              ...
              if msg.from_ in admin:
               ...
               cl.sendText(msg.to, "☆「Group List」☆\n"+ h +"Total Group : " +str(len(gid)))
                ...
                if msg.toType == 2:
                      msg.contentType = 13
                      Creatorbot = "u350cc7408cc6cc82e056ee046131f925"
                      try:
                          msg.contentMetadata = {'mid': Creatorbot}
                        
                      except:
                        Creatorbot = "Error"
                      cl.sendText(msg.to, "Babang")
                      cl.sendMessage(msg)
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to,"Ada bosque")
#-----------------------------------------------

            elif msg.text in ["Sp","Speed","speed"]:
                start = time.time()
                cl.sendText(msg.to, "¢σllme")

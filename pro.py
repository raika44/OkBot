...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token="EoMxIUUhy07LRc4ECkr5.nqZhqiZgZilGvU4eyth5jq.1Ij6rXBNjXEoOMC7MnB1PFTYOEmZzTfv8ExwSo/uCLY=")
cl.loginResult()
#vidia
kt = LINETCR.LINE()
kt.login(token="EoP4iORhQu3TIH64C8l9.nuUU5kRRG+fC3Z9YVNv7Qq.vkrRCq1uVZmnL3ZAPxxgBzPWsdK5nBlXV9iL8+R358I=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
ks.login(token="Eo7EIu2mReAJIQBW0vR3.TrVjFf5pyd8D+ZxPusvq0W.OA2DCa+UZcMEuVSn33SrloXrt4Fy6+YBJIzZXeWIqSA=")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE()
ki.login(token="EosBDjomCv98q3GuFCk2.WUI0jVzzeewupQ5tboz8mG.fDXAurfcyCtVJuXNLRbhEfvkazqUDiAr9WAg3qtfFf0=")
ki.loginResult()
#fawn
kk = LINETCR.LINE()
kk.login(token="EoC6yiexGa9METLrAc0f.9eQsWmyR4F9AFNPZDyQTtW.pOy1DHvhrV4rWlcRBpsS61UEp99+KF8oLmINJiC2Veg=")
kk.loginResult()
#iridessa
kc = LINETCR.LINE()
kc.login(token="Eo4O6c1AC8tn3nij8nM2.buJLD7JrrngDnMf5qDfqyG.T8RCksSOuUrrCIVjaFCr/AX7A5qGcMyGIvYQawYuUPA=")
kc.loginResult()
...
["u354baee4aaeb83f15cdf3f72be757ba9"]
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"u350cc7408cc6cc82e056ee046131f925","uc2e8b426f6591045943eae5304e67c32","uf44a92c0c62be1ff5a7e7a73758aad4f","u0548e577b8d144d19d36617941d15062","ub51bc97c5e4f603f1dff35e9512550d3"]
admin = ["u350cc7408cc6cc82e056ee046131f925","uc2e8b426f6591045943eae5304e67c32"]
...
#===============================================
            elif msg.text in ["Desah","Sayang"]:
              if msg.from_ in admin:
                cl.sendText(msg.to, "Ooohh aaahh...")
                start = time.time()
                time.sleep(0.0001)
...
#--------------------------------------------------------
		...
		if msg.from_ in admin and Creator:
                    for i in gid:
                        h = cl.getGroup(i).name
		        if h == ng:
			    cl.sendText(i,"Bot di paksa keluar oleh admin!")
		            cl.leaveGroup(i)
			    ki.leaveGroup(i)
			    kk.leaveGroup(i)
			    kc.leaveGroup(i)
		    ...
		    cl.sendText(msg.to,"Khusus admin and Creator")
...
#============================================
            ...
            elif msg.text.lower() in ["mention"]:
              if msg.from_ in admin:
                group = cl.getGroup(msg.to)

...
kr1 = KRIS.LINE()
#kr1.login(qr=True)
kr1.login(token="EoMxIUUhy07LRc4ECkr5.nqZhqiZgZilGvU4eyth5jq.1Ij6rXBNjXEoOMC7MnB1PFTYOEmZzTfv8ExwSo/uCLY=")
kr1.loginResult()

kr2 = KRIS.LINE()
#kr2.login(qr=True)
kr2.login(token="EosBDjomCv98q3GuFCk2.WUI0jVzzeewupQ5tboz8mG.fDXAurfcyCtVJuXNLRbhEfvkazqUDiAr9WAg3qtfFf0=")
kr2.loginResult()

kr3 = KRIS.LINE()
#kr3.login(qr=True)
kr3.login(token="EoC6yiexGa9METLrAc0f.9eQsWmyR4F9AFNPZDyQTtW.pOy1DHvhrV4rWlcRBpsS61UEp99+KF8oLmINJiC2Veg=")
kr3.loginResult()

kr4 = KRIS.LINE()
#kr4.login(qr=True)
kr4.login(token="Eo4O6c1AC8tn3nij8nM2.buJLD7JrrngDnMf5qDfqyG.T8RCksSOuUrrCIVjaFCr/AX7A5qGcMyGIvYQawYuUPA=")
kr4.loginResult()

kr5 = KRIS.LINE()
#kr5.login(qr=True)
kr5.login(token="Eo7EIu2mReAJIQBW0vR3.TrVjFf5pyd8D+ZxPusvq0W.OA2DCa+UZcMEuVSn33SrloXrt4Fy6+YBJIzZXeWIqSA=")
kr5.loginResult()
...
admin=["u350cc7408cc6cc82e056ee046131f925","uc2e8b426f6591045943eae5304e67c32",mid,mid2,mid3,mid4,mid5]
...
wait = {
    ...
    "dblack":False,
    "clock":False,
    "cNames1":"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿",
    "cNames2":"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿",
    "cNames3":"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿",
    "cNames4":"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿",
    "cNames5":"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿",
    "Wc":False,
    "Lv":False,
    "MENTION":True,
    "blacklist":{},
...
#==============================================================================#
            ...
            elif msg.text in ["T-B-A","TBA","."]: #Panggil Semua Bot
                if msg.from_ in admin:
                    G = kr1.getGroup(msg.to)
                    ginfo = kr1.getGroup(msg.to)
                    G.preventJoinByTicket = False
            ...
            elif "all" in msg.text: #keluar semua bots
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ginfo = kr1.getGroup(msg.to)
                        ...
                        try:
                            ...
                            pass
            elif "TBa1" in msg.text: #keluar bot kecuali bot induk
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ginfo = kr1.getGroup(msg.to)
                        ginfo = kr2.getGroup(msg.to)
